...
@pytest.mark.parametrize(
    ...
    [
        ...
        # As of July 26 2024, these should not be normalised
        # unless anonymise = true
        ("check ABX32ad and DDdkL204ddd", "check abx32ad and dddkl204ddd"),
        ("AB123 XYZ789", "ab123 xyz789"),
        ("none here", "none here"),
        ("XY345Z", "xy345z"),
        ...
        (
            "radii foci fungi nuclei cacti",
            "radius focus fungus nucleus cactus",
        ),  # i -> us
